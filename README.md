...
-`lang`: Changes the language of the descriptions and error message used in the built-in commands of the shell (additional shell feature)
e.g. lang chinese 

-`history`: view the 5 most recently used commands (ignoring empty inputs) entered (additional shell feature)
